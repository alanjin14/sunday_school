...
add_para("")
add_para('How did they do it? Not out of their own power but the extraordinary power of the Holy Spirit. 2 Timothy 1:7 (NIV): "For God gave us a spirit not of fear but of power and love and self-discipline."')
add_para("")
...
add_para('Look at how the passage ends: "So there was much joy in that city" (v. 8). Pastor Steve described it powerfully: "Much joy. Not private. Not quiet. Overflowing. Probably communal. Visible."')
add_para("")
...
add_para("")
add_para('Pastor Steve said: "The Gospel doesn\u2019t just fix problems \u2014 it restores joy. When God\u2019s kingdom breaks in, it\u2019s a shared collective restoration." People listened. Chains were broken. The sick were healed. Lives restored.', italic=True)
add_para("")
